...
<aside id="gm-seed-web" role="dialog" aria-modal="true" aria-label="Spletno iskanje semen">
  <div class="gm-ss-shell">
    ...
    <div id="gm-ss-content"><div class="gm-ss-empty">Iz Plant DB klikni KJE KUPITI SEME ali vpiši rastlino/sorto.</div></div>
  </div>
</aside>`);
